    ...
    var decimal_factor = decimal_places === 0 ? 1 : decimal_places * 10;
      ...
      // Animated Number
          $('#numbers ul').appear(function () {
              $('#number1').animateNumber({number: 2004}, 1500);
              $('#number2').animateNumber({number: 2374}, 1500);
              $('#number3').animateNumber({number: 9076}, 1500);
              $('#number4').animateNumber({number: 280}, 1500);
